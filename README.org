        ...
        (defun make-solarized-theme (variant theme-name)
          (let* (;; The canonical colors
            ...
            (custom-theme-set-faces
             ...
             `(fringe ((t (:foreground ,base01 :background ,(color-blend base02 base03 0.5)))))
             `(hl-line ((t (:background ,base02))))
             `(highlight ((t (:inherit hl-line))))
             `(line-number ((t (:foreground ,base01 :background ,(color-blend base02 base03 0.5) :height 0.85))))
             ...
             `(header-line ((t (:foreground ,base0 :background ,(color-blend base02 base03 0.5)))))
