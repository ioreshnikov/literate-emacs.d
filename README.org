...
*** Generic theme definition
    ...
    #+begin_src emacs-lisp :tangle tangle/solarized-definitions.el
      (defun make-solarized-theme (variant theme-name)
        (let ((base03 (color-lab-to-hex 15 -12 -12))  ;; #002a36
          ...
          (custom-theme-set-faces
           ...
           ;; `(mode-line ((t (:foreground ,base02 :background ,base1 :inverse-video t))))
           ;; `(mode-line-inactive ((t (:foreground ,base00 :background ,base02 :inverse-video t))))
           `(mode-line ((t (:foreground ,base0 :background ,(color-lab-to-hex 10 -12 -12)))))
           `(mode-line-inactive ((t (:foreground ,base00 :background ,(color-lab-to-hex 12 -12 -12)))))
