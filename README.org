      ...
      (defun make-solarized-theme (variant theme-name)
        (let* (;; The canonical colors
          ...
          (custom-theme-set-faces
           ...
           `(mu4e-header-key-face ((t (:inherit default))))
           `(mu4e-replied-face ((t (:inherit default))))
           `(mu4e-title-face ((t (:inherit markdown-header-face))))
           `(mu4e-header-title-face ((t (:foreground ,base00))))
           `(mu4e-highlight-face ((t (:foreground ,base1 :background ,base03 :bold t))))
           `(mu4e-header-highlight-face ((t (:inherit hl-line :bold nil))))
           `(mu4e-unread-face ((t (:foreground ,base2))))

           `(gnus-header-name ((t (:foreground ,base00))))
           `(gnus-header-from ((t (:foreground ,base0))))
           `(gnus-header-subject ((t (:inherit markdown-header-face))))
           `(gnus-header-content ((t (:foreground ,base00))))

           `(gnus-cite-1 ((t (:inherit rainbow-delimiters-depth-2-face))))
           `(gnus-cite-2 ((t (:inherit rainbow-delimiters-depth-3-face))))
           `(gnus-cite-3 ((t (:inherit rainbow-delimiters-depth-4-face))))
           `(gnus-cite-4 ((t (:inherit rainbow-delimiters-depth-5-face))))
           `(gnus-cite-5 ((t (:inherit rainbow-delimiters-depth-6-face))))
           `(gnus-cite-6 ((t (:inherit rainbow-delimiters-depth-7-face))))
           `(gnus-cite-7 ((t (:inherit rainbow-delimiters-depth-8-face))))
           `(gnus-cite-8 ((t (:inherit rainbow-delimiters-depth-9-face))))
           )))
