...
** Mode-line
   ...
   I just use the default modeline from ~doom emacs~.
   #+begin_src emacs-lisp
...
** Python
   ...
   To work with python virtual environments I use ~pipenv~. There is a nice little package that integrates it into emacs
   #+begin_src emacs-lisp
     (use-package pipenv
       :ensure t
...
** Haskell
   :PROPERTIES:
   :ID:       094e86aa-bc97-488a-9999-77bd899f27dd
   :END:
      ...
      (defun make-solarized-theme (variant theme-name)
        (let* (;; The canonical colors
          ...
          (custom-theme-set-faces
           ...
           `(mode-line ((t (:foreground ,mode-line-fg :background ,mode-line-bg))))
           `(mode-line-inactive ((t (:foreground ,mode-line-ia-fg :background ,mode-line-ia-bg))))
           ...
           `(doom-modeline-buffer-modified ((t (:inherit mode-line-buffer-id))))
           `(doom-modeline-project-dir ((t (:inherit mode-line-buffer-id))))

           `(doom-modeline-debug ((t (:foreground ,base0 :bold nil))))
           `(doom-modeline-info ((t (:foreground ,green :bold nil))))
