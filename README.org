...
** Window management
   ...
   (use-package window-purpose
     ...
     (add-to-list 'purpose-user-mode-purposes '(magit-diff-mode . git))
     (add-to-list 'purpose-user-mode-purposes '(magit-log-mode . git))
     (add-to-list 'purpose-user-mode-purposes '(magit-status-mode . git))
...
** Shell
   ...
   (bind-key (kbd "C-c t") 'eshell-popup)
   #+end_src
