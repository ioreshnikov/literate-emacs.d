...
** Icons
   ...
   #+begin_src emacs-lisp
     (use-package all-the-icons
       ...
       (setq all-the-icons-default-adjust -0.50)
      ...
      (defun make-solarized-theme (variant theme-name)
        (let ((base03 (color-lab-to-hex 15 -12 -12))
          ...
          (custom-theme-set-faces
           ...
           `(doom-modeline-bar ((t (:inherit modeline))))
           `(doom-modeline-bar-inactive ((t (:inherit modeline-inactive))))
           `(doom-modeline-buffer-path ((t (:inherit nil))))
           ...
           `(doom-modeline-highlight ((t (:inherit nil))))
           `(doom-modeline-debug ((t (:inherit nil))))
           `(doom-modeline-info ((t (:inherit nil))))
           `(doom-modeline-warning ((t (:inherit nil))))
           `(doom-modeline-error ((t (:inherit nil))))
           )))
