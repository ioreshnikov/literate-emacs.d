...
*** Scrolling
    ...
    #+begin_src emacs-lisp
      ...
      ;; Of course any reasonable person would expect that this is how
      ;; you make emacs scroll one line at a time. Well, that's your fault,
      ;; a hypothetical reasonable person. This is emacs! Land of the brave
      ;; and wise! Don't even dare to step here if haven't read the complete
      ;; reference! If you had done this then you would obviously know that the
      ;; way to make emacs scroll one line at a time is to set this

      (setq scroll-conservatively 100)

      ;; You see! It's easy and logical and obvious!

      ;; PS: Jokes aside, I should just move to VIM already. Nothing will save
      ;; this editor. It's a pile of steaming crap that has been accumulating for
      ;; 50 years and the clowns that run the development process don't seem to think
      ;; that it's anything wrong with it.
    #+end_src
...
*** Lighters
    ...
    Some of them are builtin and we might as well diminish them here right away
    #+begin_src emacs-lisp
      (diminish 'eldoc-mode)
...
*** Fonts
    ...
    #+begin_src emacs-lisp
      ...
      ;; OH GOD, THEY'RE TRYING TO USE VARIABLE PITCH FACES MORE AND MORE IN THE
      ;; DESIGN.
      (set-face-attribute
...
*** COMMENT Beacon!
    ...
    *NOTE*: Commented due to performance degradation :( In theory I could
    report this, but it's not worth it. Emacs is sluggish and the developers
    would rather blame the users than fix anything. See this beautiful example:

    https://www.reddit.com/r/emacs/comments/d2n2wh/emacs_is_slow_on_macos/

*** Underline

    I hit a weird bug: underline is at the baseline so I cannot see an underscore sometime.
    #+begin_src emacs-lisp
      (setq x-use-underline-position-properties nil)
      (setq underline-minimum-offset 5)
      ;; XXX: Actually, it does NOTHING for the wavy underline, which is the
      ;; reason why I started to play with this option in the first place.
      ;; AH THE CONSISTENCY
    #+end_src
        ...
        (defun make-solarized-theme (variant theme-name)
          (let* (;; The canonical colors
            ...
            (custom-theme-set-faces
             ...
             `(mode-line-buffer-id ((t (:height 0.95 :bold t))))
             ...
             `(company-tooltip-scrollbar-thumb ((t (:background ,base02))))
             `(company-tooltip-scrollbar-track ((t (:background ,base01))))
             ...
             `(tree-sitter-hl-face:property ((t (:inherit italic))))
             ...
             `(tree-sitter-hl-face:function.call ((t (:inherit nil))))
             ...
             `(dired-directory ((t (:foreground ,base1 :bold t))))
