...
** Shell
   ...
   I want a quick way to open the shell in the directory of the file I'm editing. I used to have a custom function for that, but ~eshell-toggle~ does it better.
   #+begin_src emacs-lisp
