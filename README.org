      ...
      #+begin_src emacs-lisp :tangle tangle/solarized-definitions.el
        (defun make-solarized-theme (variant theme-name)
          (let* (;; The canonical colors
                 ...
                 (solaire-base03 (color-lab-to-hex 10 -12 -12))
                 (solaire-base02 base03)

                 (solaire-base2 (color-lab-to-hex 87 +00 +10))
                 (solaire-base3 base2)
            ...
            (custom-theme-set-faces
             ...
             `(solaire-fringe-face ((t (:background ,solaire-base02))))
             `(solaire-line-number-face ((t (:background ,solaire-base02))))
             )))
