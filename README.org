      ...
      (defun make-solarized-theme (variant theme-name)
        (let* (;; The canonical colors
          ...
          (custom-theme-set-faces
           ...
           `(company-tooltip-annotation ((t (:background ,(color-blend base02 base01 0.55)))))
           ...
           `(vterm-color-green ((t (:foreground ,base01 :background ,green))))
           `(vterm-color-blue ((t (:foreground ,base0 :background ,blue))))
           `(vterm-color-cyan ((t (:foreground ,base1 :background ,cyan))))
           ...
           `(vterm-color-yellow ((t (:foreground ,base00 :background ,yellow))))

           `(transient-separator ((t (:inherit default))))

           `(lsp-headerline-breadcrumb-path-face ((t (:height 0.9))))
           `(lsp-headerline-breadcrumb-path-error-face ((t (:underline nil :height 0.9))))
           `(lsp-headerline-breadcrumb-path-hint-face ((t (:underline nil :height 0.9))))
           `(lsp-headerline-breadcrumb-path-info-face ((t (:underline nil :height 0.9))))
           `(lsp-headerline-breadcrumb-path-warning-face ((t (:underline nil :height 0.9))))
           `(lsp-headerline-breadcrumb-symbols-face ((t (:height 0.9))))
           `(lsp-headerline-breadcrumb-symbols-error-face ((t (:underline nil :height 0.9))))
           `(lsp-headerline-breadcrumb-symbols-hint-face ((t (:underline nil :height 0.9))))
           `(lsp-headerline-breadcrumb-symbols-info-face ((t (:underline nil :height 0.9))))
           `(lsp-headerline-breadcrumb-symbols-warning-face ((t (:underline nil :height 0.9))))
           )))
