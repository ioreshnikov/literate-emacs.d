      ...
      (defun make-solarized-theme (variant theme-name)
        (let ((base03 (color-lab-to-hex 15 -12 -12))
          ...
          (custom-theme-set-faces
           ...
           `(mood-line-modified ((t (:inherit nil))))
           `(mood-line-status-neutral ((t (:inherit nil))))
           `(mood-line-status-info ((t (:inherit nil))))
           `(mood-line-status-success ((t (:inherit nil))))
           `(mood-line-status-warning ((t (:inherit nil))))
           `(mood-line-status-error ((t (:inherit nil))))
