...
*** Fonts
    ...
    A similar hacks are possible for the other Fonts (but come on, ~emacs~ it's 2021, why doesn't it work out-of-the-box). Here's an example for JetBrains Mono.
    #+begin_src emacs-lisp
      ...
      (add-hook 'prog-mode-hook
                (lambda ()
                  (when (string= monospace-font-family "JetBrains Mono")
    ...
    #+end_src
    The snippet above is taken from https://emacs.stackexchange.com/a/55936
        ...
        (defun make-solarized-theme (variant theme-name)
          (let* (;; The canonical colors
            ...
            (custom-theme-set-faces
             ...
             `(doom-modeline-lsp-error ((t (:inherit error :height 0.95))))
             ...
             `(doom-modeline-lsp-warning ((t (:inherit warning :height 0.95))))
             `(doom-modeline-project-dir ((t (:height 0.95))))
             `(doom-modeline-urgent ((t (:inherit (error bold) :height 0.95))))
             `(doom-modeline-warning ((t (:inherit warning :height 0.95))))
             )))
